...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Grafico della Binomiale (n=10, p=0.5)}
        \label{fig:img1}
    \end{subfigure}
    \hfill 
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Grafico della Poissoniana}
        \label{fig:img2}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        ...
        \caption{Confronto e limite per $n \to \infty$}
        \label{fig:img3}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Grafico di confronto finale}
    \end{subfigure}
    
    \caption{Distribuzioni nel limite e confronto binomiale/poissoniana}
\end{figure}
...
\]
Questo ci permette di confrontare i dati sperimentali con la curva teorica $P(x)$.


\lezione{???}{02 Febbraio 2026}
