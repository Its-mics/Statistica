...
Quando analizziamo un set di dati sperimentali $N \to \{x_1, x_2, ..., x_N\}$, possiamo stimare la distribuzione di probabilità sottostante tramite un istogramma. L'istogramma divide il range dei dati in intervalli (bin).
